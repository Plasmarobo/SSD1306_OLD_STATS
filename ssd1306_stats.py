...
while True:
    ...
    pad = 4
    offset = 0
    draw.text((x, top + offset), f"IP: {IP}", font=font, fill=255)
    offset += pad + cheight
    draw.text((x, top + offset), f"CPU: {CPU}", font=font, fill=255)
    offset += pad + cheight
    draw.text((x, top + offset), f"{MemUsage} ", font=font, fill=255)
    offset += pad + cheight
    draw.text((x, top + offset), f"{Disk} ", font=font, fill=255)
    offset += pad + cheight
    draw.text((x, top + offset), f"Host: {Host} ", font=font, fill=255)
